...
public class RxBus {
     ...
     * @param <T>
     */
    public <T> void registerRxBus(Object o,Class<T> eventType, Consumer<T> action,Consumer<Throwable> throwableConsumer) {
        Disposable disposable = mRxBus.doSubscribe(eventType, action, throwableConsumer);
        mRxBus.addSubscription(o,disposable);
    }
